...
const Work = () => {
  ...
  return (
    <section
      className="h-auto flex flex-col items-start justify-start pt-20 md:pt-24 px-4 snap-start"
      id="projects"
    >
      ...
      <div className="w-full min-h-auto flex justify-center items-center mt-8 md:mt-0 cursor-pointer">
        <div className="w-full max-w-screen-xl px-4">
          <div className="w-full pt-5 md:pt-14 text-green-300 dark:text-[#00FF00] tracking-widest font-tomorrow font-semibold text-[2em] text-center mb-8">
